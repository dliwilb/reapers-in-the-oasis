...
async function shakeIt() {
    ...
    for (let i = 0; i < events.length; i++) {
        ...
        document.getElementById('list-of-reapers').innerHTML = 
            ...
            `<a href="https://oasis.cash/token/${nftContractAddress}/${tokenId}" target="_blank">Check it out on OASIS&thinsp;<img src="icons8-external-link-16_goldish.png"></a></p><br>`;
